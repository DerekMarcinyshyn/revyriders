<?php // AddThis Social Sign On

if ( function_exists( 'addthis_ssi') ) { ?>

	<div class="add-this-social-login">
		<h3>Register with Social Sign In</h3>
		<?php addthis_ssi(); ?>
	</div>
...
<div id="buddypress">
	...
	<div class="page" id="register-page">
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<h3>Or use Regular Site Registration</h3>
