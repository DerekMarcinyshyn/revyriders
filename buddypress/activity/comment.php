...
<li id="acomment-<?php bp_activity_comment_id(); ?>">
	...
	<div class="acomment-options">
		...
		<?php if ( bp_activity_user_can_delete() ) : ?>
			...
			<a href="<?php bp_activity_comment_delete_link(); ?>" class="btn btn-danger delete acomment-delete confirm bp-secondary-action" rel="nofollow"><?php _e( 'Delete', 'buddypress' ); ?></a>
